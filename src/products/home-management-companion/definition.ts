...
export const homeManagementCompanionDefinition: ProductDefinitionInput = {
  ...
  navigation: ["start", "setup", "workspace", "attention", "records", "history", "settings"],
  primaryNavigation: ["workspace", "attention", "records"],
  ...
  modules: [
    ...
    { id: "home-management-companion.records", destination: "records" },
