...
/**
 * Text-file input, Home Base's own parallel to PFC's TextFileStep.tsx. The
 * file's raw bytes are read entirely in the browser and never uploaded to
 * storage, only the extracted text is used, and only its metadata (name/
 * size/type) is kept for provenance on the import session.
 */
