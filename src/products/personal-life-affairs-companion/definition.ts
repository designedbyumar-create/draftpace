...
export const personalLifeAffairsCompanionDefinition: ProductDefinitionInput = {
  ...
  pwa: {
    ...
    icons: [
      { src: "/logo/products/personal-life-affairs-companion/icon-192.png", sizes: "192x192", type: "image/png", purpose: "any" },
      { src: "/logo/products/personal-life-affairs-companion/icon-512.png", sizes: "512x512", type: "image/png", purpose: "any" },
      { src: "/logo/products/personal-life-affairs-companion/icon-maskable-512.png", sizes: "512x512", type: "image/png", purpose: "maskable" },
    ],
