...
export interface AffairStep {
  ...
  key: string;
  area: AffairArea;
  /** The hero line, shown in the app. An instruction, specific, in the second person. */
  instruction: string;
  /**
   * What this entry is called in the printed book, as a fact rather than
   * an instruction.
   *
   * The two cannot be the same string, and that is the whole reason this
   * field exists. In the app the reader is the owner and "Write down who
   * should be called first" is exactly right. In the filled book the
   * reader is somebody else, holding it at the worst moment of their
   * week, and the same sentence reads as a job they have been given.
   * They need the heading to say what the thing below it IS: "Who to
   * contact first", then the name.
   *
   * The blank copy deliberately keeps `instruction`, because there the
   * reader is the owner again and it is a form they are filling in.
   */
  bookLabel: string;
...
export const AFFAIR_STEPS: AffairStep[] = [
  // ---------------------------------------------------------------- people
  {
    ...
    bookLabel: "Who to contact first",
  ...
  },
  {
    ...
    bookLabel: "Who would sort things out",
  ...
  },
  {
    ...
    bookLabel: "If that person cannot",
  ...
  },
  {
    ...
    bookLabel: "The person chosen has been told",
  ...
  },
  {
    ...
    bookLabel: "Who speaks about medical care",
  ...
  },
  {
    ...
    bookLabel: "Professionals who already know",
  ...
  // ------------------------------------------------------------- paperwork
  {
    ...
    bookLabel: "The will, and where it is",
  ...
  },
  {
    ...
    bookLabel: "Birth certificate, passport and ID",
  ...
  },
  {
    ...
    bookLabel: "Marriage or divorce papers",
  ...
  },
  {
    ...
    bookLabel: "Safes and deposit boxes",
  ...
  },
  {
    ...
    bookLabel: "Where money comes in from",
  ...
  },
  {
    ...
    bookLabel: "The named people were checked",
  ...
  },
  {
    ...
    bookLabel: "The named people were updated",
  ...
  },
  {
    ...
    bookLabel: "The workplace plan was checked",
  ...
  },
  {
    ...
    bookLabel: "What is owed, and to whom",
  ...
  },
  {
    ...
    bookLabel: "What leaves the account automatically",
  ...
  // ------------------------------------------------------------------- home
  {
    ...
    bookLabel: "The home, owned or rented",
  ...
  },
  {
    ...
    bookLabel: "Home and contents insurance",
  ...
  // ------------------------------------------------------------- dependants
  {
    ...
    bookLabel: "Who would raise the children",
  ...
  },
  {
    ...
    bookLabel: "The guardian has been asked",
  ...
  },
  {
    ...
    bookLabel: "Who would take the pets",
  ...
  // ---------------------------------------------------------------- digital
  {
    ...
    bookLabel: "Someone can unlock the phone",
  ...
  },
  {
    ...
    bookLabel: "The main email address",
  ...
  },
  {
    ...
    bookLabel: "Getting into the accounts",
  ...
  },
  {
    ...
    bookLabel: "Online accounts that charge money",
  ...
  },
  {
    ...
    bookLabel: "Legacy contacts have been set",
  ...
  },
  {
    ...
    bookLabel: "Where the photographs are",
  ...
  // ----------------------------------------------------------------- wishes
  {
    ...
    bookLabel: "About medical treatment",
  ...
  },
  {
    ...
    bookLabel: "What they would want arranged",
  ...
  },
  {
    ...
    bookLabel: "Belongings with meaning",
  ...
  },
  {
    ...
    bookLabel: "Anything written for someone",
  ...
  // --------------------------------------------------------------- business
  {
    ...
    bookLabel: "The business paperwork",
  ...
  },
  {
    ...
    bookLabel: "Who could run the business",
