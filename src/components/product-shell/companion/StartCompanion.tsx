 ...
 * Shared runtime, proven first by Alongside.
 *
 ...
 * continue.
 */
export default function StartCompanion<TContext extends string = string>({
  playbooks,
  eyebrow = "Help",
  prompt = "What do you need to do?",
  placeholder = "In your own words",
  situationsLabel = "Or, what's going on?",
  onStart,
  onCancel,
}: {
  playbooks: Playbook<TContext>[];
  eyebrow?: string;
  prompt?: string;
  placeholder?: string;
  situationsLabel?: string;
  onStart: (playbook: Playbook<TContext>, title: string | null) => void;
