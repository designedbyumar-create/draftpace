...
import { ArrowRight, Bell, Check, Clock, Flame, Layers3, Lightning, LinkSimple, Shield, Smartphone, TrendingUp, X } from "@/components/ui/Icon";
      ...
      <motion.div {...fadeUp(0.1)}
        ...
        <div className="p-6">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px] font-medium bg-orange-50 border border-orange-200 text-orange-600 mb-3">
            <Lightning size={10} color="#f97316" filled />
      ...
      <motion.div {...fadeUp(0.1)}
        ...
        <div className="flex items-center gap-3 mb-5">
          <div className="w-12 h-12 bg-indigo-600 rounded-2xl flex items-center justify-center shrink-0">
            <Lightning size={20} color="white" filled />
          </div>
          <div>
...
// ─────────────────────────────────────────────────────────────────────────────
const GRID_FEATURES = [
  { Icon: Layers3,    color:"#4f46e5", bg:"#eef2ff", title:"All content types",      desc:"Planners, checklists, ebooks, guides — every format works the same way."                             },
  { Icon: Shield,     color:"#059669", bg:"#ecfdf5", title:"Secure & private",        desc:"Your progress data is yours. We don't sell it, share it, or look at it."                             },
  { Icon: Bell,       color:"#f59e0b", bg:"#fff7ed", title:"Smart reminders",          desc:"Notified when you're likely to forget — not every hour like a fitness app."                          },
  { Icon: TrendingUp, color:"#7c3aed", bg:"#fdf4ff", title:"Completion analytics",     desc:"12-week heatmaps, monthly averages, and patterns you can actually use."                              },
  { Icon: LinkSimple, color:"#be185d", bg:"#fff0f7", title:"Gumroad & Etsy sync",      desc:"Connect once. Every purchase auto-imports without you lifting a finger."                             },
  { Icon: Smartphone, color:"#0d9488", bg:"#f0fdfa", title:"Native mobile feel",       desc:"Bottom nav, swipeable cards, safe-area support. Feels like an app, not a website."                   },
];
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <motion.div {...fadeUp(0.3)} className="flex items-center justify-center gap-3 flex-wrap">
            <MarketingButton
              ...
              className="rounded-2xl text-[15px] font-bold"
            >
              Get started free
            </MarketingButton>
            <MarketingButton
              ...
              size="lg"
              variant="secondary"
              className="rounded-2xl text-[15px] font-semibold"
            >
              See pricing
            </MarketingButton>
          </motion.div>
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <motion.div {...fadeUp()}>
            <div className="inline-flex items-center gap-2 bg-white border border-gray-200 px-4 py-2 rounded-full shadow-sm mb-7">
              <Lightning size={12} color="#4f46e5" filled />
