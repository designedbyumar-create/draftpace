...
export default async function ProductVisitsPage({
  params,
}: {
  ...
  const Module = resolveProductModule(definition, "visits");
  if (Module) return <Module definition={definition} />;

  return (
    <div>
      <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-[var(--primary)]">Visits</p>
      <div className="mt-6">
        <EmptyState
          icon={Clock}
