...
export default async function ProductDebtPage({
  params,
}: {
  ...
  const Module = resolveProductModule(definition, "debt");
  if (Module) return <Module definition={definition} />;

  return (
    <EmptyState
      icon={CreditCard}
      title="No debt destination for this product"
      description="This product does not manage debt directly."
    />
  );
}
