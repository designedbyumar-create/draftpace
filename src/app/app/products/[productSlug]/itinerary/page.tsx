...
export default async function ProductItineraryPage({
  params,
}: {
  ...
  const Module = resolveProductModule(definition, "itinerary");
  if (Module) return <Module definition={definition} />;

  return (
    <div>
      <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-[var(--primary)]">Itinerary</p>
      <div className="mt-6">
        <EmptyState
          icon={Clock}
