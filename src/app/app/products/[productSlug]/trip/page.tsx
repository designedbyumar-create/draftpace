...
export default async function ProductTripPage({
  params,
}: {
  ...
  const Module = resolveProductModule(definition, "trip");
  if (Module) return <Module definition={definition} />;

  return (
    <div>
      <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-[var(--primary)]">Trip</p>
      <div className="mt-6">
        <EmptyState
          icon={Clock}
