...
export default async function ProductPaperworkPage({
  params,
}: {
  ...
  const Module = resolveProductModule(definition, "paperwork");
  if (Module) return <Module definition={definition} />;

  return (
    <div>
      <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-[var(--primary)]">Paperwork</p>
      <div className="mt-6">
        <EmptyState
          icon={Clock}
